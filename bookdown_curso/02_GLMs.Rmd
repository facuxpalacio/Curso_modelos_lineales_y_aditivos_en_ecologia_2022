...
### Ejercicio 3.1
Los datos del archivo **gala.xls** corresponden a un estudio donde se relevó la diversidad de especies de tortugas de las Islas Galápagos. En cada isla se midieron la riqueza de especies (**Species**), el área (**Area**), la altitud (**Elevation**), distancia a la isla más cercana (**Nearest**), distancia a la isla Santa Cruz (**Scruz**) y el área de la isla adyacente (**Adjacent**). 
...
### Ejercicio 3.4
Raventos et al. (2019) evaluaron la respuesta de rasgos de historia de vida en varias especies de peces utilizando técnicas reconstructivas de otolitos a diferentes variables ambientales (https://doi.org/10.1111/1365-2656.13435). Para esto, se estimaron varios caracteres de historia de vida, incluyendo la duración larval pelágica (**PLD**), la tasa de crecimiento (**Pre-settlement_growth**), el tamaño de asentamiento (**Size_of_settlement**) y la fecha de puesta (**Hatching_day_date**). El conjunto de datos se encuentra en el archivo **Raventos_etal_2021_JAE_data**. 
